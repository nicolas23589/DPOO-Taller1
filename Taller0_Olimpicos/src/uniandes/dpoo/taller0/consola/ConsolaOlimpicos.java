...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Buscar de que país es un atleta\n");
	}
	...
	{
		System.out.println("\n" + "País de origen de un atleta (nueva opcion)" + "\n");
			...
			String pais = calculadora.pais_del_atleta(nombre_atleta);
			
			System.out.println("El atleta " + nombre_atleta + " pertenece al país de " + pais);
